...
namespace App.Cmd.Infrastructure.Handlers
{
    public class EventSourcingHandler : IEventSourcingHandler<MapAggregate>
    {
        ...
        public async Task<MapAggregate> GetByIdAsync(Guid aggregateId)
        {
            var aggregate = new MapAggregate();
